...
export default function Page() {
  ...
  return (
    <div>
      <div className="py-8 w-full min-h-screen bg-slate-300">
        <h2 className="text-center text-3xl text-slate-800 py-12">
          Sent Messages
        </h2>

        <div className="w-full grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 p-4 place-items-center gap-2">
            ...
            return (
              <div
                ...
                className={
                  ...
                  " p-4 shadow rounded w-full h-[15rem]"
                }
              >
                  ...
                  <div className="flex items-start justify-between w-full">
                    <div className="pl-3 w-full">
                      ...
                      <p className="text-sm leading-normal pt-2 text-gray-500">
                        {moment(message?.createdAt).format("hh:mm A , D MMM Y")}
                      </p>
                    </div>
                    <svg
                      width={28}
